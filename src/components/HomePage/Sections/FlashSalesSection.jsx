  ...
  return (
    <div className="flash-sales mt-16 mb-12 px-4 bg-white relative">
      ...
      <div className="flex items-center mb-6">
        <h2 className="text-4xl font-medium mr-16">Flash Sales</h2>
        <div className="text-2xl text-gray-900 flex items-center">
          <div className="flex flex-col">
            <div className="flex space-x-8 text-[11px] -my-2 font-semibold text-gray-900">
            ...
            <div className="flex space-x-4">
              ...
              <span className="font-semibold text-3xl">23</span>
              <span className="text-red-500 mx-1">:</span>
