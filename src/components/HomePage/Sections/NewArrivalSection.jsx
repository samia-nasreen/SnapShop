const NewArrivalSection = () => {
  return (
    <div className="py-8 mt-16 mb-12 px-4 bg-white relative">
      ...
      <h2 className="text-3xl font-medium mb-12">New Arrival</h2>
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        <div className="relative group lg:col-span-2 lg:row-span-2">
          ...
          <div className="absolute bottom-4 left-4 p-4 w-full text-white">
            <h3 className="text-2xl font-semibold">PlayStation 5 Pro</h3>
            <p className="text-md w-2/3 my-3">
              A new Sony PlayStation 5 Pro launching soon.
            </p>
            <button className="mt-2 text-lg pb-1 border-b-[1.5px] border-gray-500 hover:text-gray-300">
              Shop Now
            </button>
          </div>
        </div>
        ...
        <div className="relative group">
          ...
          />
          <div className="absolute bottom-4 left-4 p-4 w-full text-white">
            <h3 className="text-2xl font-semibold">Headphones</h3>
            <p className="text-md my-3">Wireless Headphones</p>
            <button className="mt-2 text-lg pb-1 border-b-[1.5px] border-gray-500 hover:text-gray-300">
              Shop Now
            </button>
          </div>
        ...
        <div className="relative group">
          ...
          <div className="absolute bottom-4 left-4 p-4 w-full text-white">
            ...
            <p className="text-md my-3">GUCCI INTENSE OUD EDP</p>
            <button className="mt-2 text-lg pb-1 border-b-[1.5px] border-gray-500 hover:text-gray-300">
              Shop Now
            </button>
          </div>
